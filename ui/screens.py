...
class MenuScreen:
    def __init__(self, screen):
        ...
        cx = SCREEN_WIDTH // 2
        self.play_button = Button(cx, 528, 320, 56, "Play", SWAP_GREEN, SWAP_GREEN_HOVER)
        self.tutorial_button = Button(cx, 590, 320, 44, "Tutorial", PEEK_BLUE, PEEK_BLUE_HOVER)
        self.how_to_button = Button(cx, 640, 320, 44, "How To Play", PAIR_TEAL, PAIR_TEAL_HOVER)
        self.profile_button = Button(cx, 690, 320, 44, "Profile & Stats", DISCARD_ORANGE, DISCARD_ORANGE_HOVER)
        self.settings_button = Button(cx, 740, 320, 44, "Settings", (110, 90, 50), (140, 115, 65))
        self.quit_button = Button(cx, 790, 320, 44, "Quit", DECLARE_RED, DECLARE_RED_HOVER)
