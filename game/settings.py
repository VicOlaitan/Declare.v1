...
from config import (
    ...
    DEFAULT_LAYOUT_MODE, DEFAULT_HAND_SIZE, DEFAULT_PEEK_COUNT, DEFAULT_REACTION_WINDOW,
...
class GameSettings:
    ...
    reaction_window_seconds: float = DEFAULT_REACTION_WINDOW
    ...
    def apply_persistent(self, settings_bag):
        """Sync values from a persisted profile.SettingsBag."""
